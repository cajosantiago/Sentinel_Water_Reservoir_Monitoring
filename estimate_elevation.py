...
def extract_border_pixels(seg_mask):
    ...
    return border_xs_list, border_ys_list
...
def estimate_elevation(
    ...
    *,
    ...
    border_xs, border_ys = extract_border_pixels(seg_mask)
    ...
    border_xs = np.concatenate(border_xs)
    border_ys = np.concatenate(border_ys)
